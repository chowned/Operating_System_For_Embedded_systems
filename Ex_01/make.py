...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file lab01_ex01.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=posix/linux --templates=../../goil/templates lab01_ex01.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("lab01_ex01/tpl_app_config.c")

sourceList.append("lab01_ex01/tpl_os.c")
