...
#--- automatically generated by goil on Wed Oct 26 21:46:15 2022
#--- from root OIL file lab01_ex01.oil
#---
...
cflags += "-ggdb".split()
includeDirs += ["-I","/home/gaetano/Documenti/trampoline//machines/posix"]
includeDirs += ["-I","/home/gaetano/Documenti/trampoline//machines/../viper"]
if with_ioc:
...
#--- OIL file
oilSourceList.append("lab01_ex01.oil")
...
cSourceList.append(projfile.ProjectFile("lab01_ex01.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("lab01_ex01/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("lab01_ex01/tpl_os.c"))
...
postVariableMapping = dict(
  ...
  ARCH_PATH='/home/gaetano/Documenti/trampoline//machines/posix',
  BOARD_PATH='/home/gaetano/Documenti/trampoline//machines/posix/linux',
  TARGET='posix/linux'
)
