...
#--- automatically generated by goil on Thu Nov 17 19:49:41 2022
...
if True:
  postCommand = makefile.PostCommand("Generating binary lab_2_ex_1_exe.hex from lab_2_ex_1_exe")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("lab_2_ex_1_exe")
  postCommand.mCommand.append("lab_2_ex_1_exe.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    commandLine += "lab_2_ex_1_exe.hex "
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing lab_2_ex_1_exe on avr/arduino/uno\033[0m")
