...
#--- automatically generated by goil on Fri Nov 11 22:58:41 2022
#--- from root OIL file lab01_ex02.oil
#---
...
sys.path.append("/home/gaetano/Documenti/trampoline//make")
...
includeDirs += ["-I","/home/gaetano/Documenti/trampoline//machines/avr/arduino/cores/arduino"]
includeDirs += ["-I","/home/gaetano/Documenti/trampoline//machines/avr/arduino/"]
includeDirs += ["-I","/home/gaetano/Documenti/trampoline//machines/avr/arduino/variants/standard"]
includeDirs += ["-I","/home/gaetano/Documenti/trampoline//machines/avr"]
if with_ioc:
  includeDirs += ["-I", "/home/gaetano/Documenti/trampoline//ioc"]
includeDirs += ["-I", "/home/gaetano/Documenti/trampoline//os"]
includeDirs += ["-I", "/home/gaetano/Documenti/trampoline//debug"]
includeDirs += ["-I", "lab01_ex02"]
cflags   += includeDirs
...
#--- OIL file
oilSourceList.append("lab01_ex02.oil")
...
cflags += ["-I", "/home/gaetano/Documenti/trampoline//com"]
cppflags += ["-I", "/home/gaetano/Documenti/trampoline//com"]
...
cSourceList.append(projfile.ProjectFile("lab01_ex02.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("lab01_ex02/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("lab01_ex02/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("lab01_ex02/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("lab01_ex02/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary ex2_exe.hex from ex2_exe")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("ex2_exe")
  postCommand.mCommand.append("ex2_exe.hex")
...
postVariableMapping = dict(
  MACHINE_PATH='/home/gaetano/Documenti/trampoline//machines',
  ARCH_PATH='/home/gaetano/Documenti/trampoline//machines/avr',
  BOARD_PATH='/home/gaetano/Documenti/trampoline//machines/avr/arduino/uno',
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing ex2_exe on avr/arduino/uno\033[0m")
