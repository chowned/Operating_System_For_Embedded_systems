...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file lab01_ex02.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=avr/arduino/uno --templates=/home/gaetano/Documenti/trampoline/goil/templates lab01_ex02.oil")
	sys.exit(1)
...
#----------------------------------------------------------------------
oilFile = "lab01_ex02.oil"
oilFileDep = "build/" + oilFile + ".dep"
oilCompiler = "goil"
oilFlags = ["-t=avr/arduino/uno", "--templates=/home/gaetano/Documenti/trampoline/goil/templates"]
...
#--- Add generated files
sourceList.append("lab01_ex02/tpl_app_config.c")

sourceList.append("lab01_ex02/tpl_dispatch_table.c")
sourceList.append("lab01_ex02/tpl_invoque.S")
sourceList.append("lab01_ex02/tpl_interrupts.c")
