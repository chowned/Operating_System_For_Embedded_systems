...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Make file for application three_tasks
...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file lab03_ex04.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=avr/arduino/uno --templates=/home/gulistan/Documents/trampoline/goil/templates lab03_ex04.oil")
	sys.exit(1)
...
#----------------------------------------------------------------------
oilFile = "lab03_ex04.oil"
oilFileDep = "build/" + oilFile + ".dep"
oilCompiler = "goil"
oilFlags = ["-t=avr/arduino/uno", "--templates=/home/gulistan/Documents/trampoline/goil/templates"]
...
#--- Add generated files
sourceList.append("lab03_ex04/tpl_app_config.c")

sourceList.append("lab03_ex04/tpl_dispatch_table.c")
sourceList.append("lab03_ex04/tpl_invoque.S")
sourceList.append("lab03_ex04/tpl_interrupts.c")
