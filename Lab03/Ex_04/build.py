...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Build file for application three_tasks
...
sys.path.append("/home/gulistan/Documents/trampoline//make")
...
includeDirs += ["-I","/home/gulistan/Documents/trampoline//machines/avr/arduino/cores/arduino"]
includeDirs += ["-I","/home/gulistan/Documents/trampoline//machines/avr/arduino/"]
includeDirs += ["-I","/home/gulistan/Documents/trampoline//machines/avr/arduino/variants/standard"]
includeDirs += ["-I","/home/gulistan/Documents/trampoline//machines/avr"]
if with_ioc:
  includeDirs += ["-I", "/home/gulistan/Documents/trampoline//ioc"]
includeDirs += ["-I", "/home/gulistan/Documents/trampoline//os"]
includeDirs += ["-I", "/home/gulistan/Documents/trampoline//debug"]
includeDirs += ["-I", "lab03_ex04"]
cflags   += includeDirs
...
#--- OIL file
oilSourceList.append("lab03_ex04.oil")
...
cflags += ["-I", "/home/gulistan/Documents/trampoline//com"]
cppflags += ["-I", "/home/gulistan/Documents/trampoline//com"]
...
cSourceList.append(projfile.ProjectFile("lab03_ex04.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("lab03_ex04/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("lab03_ex04/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("lab03_ex04/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("lab03_ex04/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary Lab_3_ex_4_exe.hex from Lab_3_ex_4_exe")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("Lab_3_ex_4_exe")
  postCommand.mCommand.append("Lab_3_ex_4_exe.hex")
...
postVariableMapping = dict(
  MACHINE_PATH='/home/gulistan/Documents/trampoline//machines',
  ARCH_PATH='/home/gulistan/Documents/trampoline//machines/avr',
  BOARD_PATH='/home/gulistan/Documents/trampoline//machines/avr/arduino/uno',
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    commandLine += "Lab_3_ex_4_exe.hex "
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing Lab_3_ex_4_exe on avr/arduino/uno\033[0m")
