...
sys.path.append("/home/$USER/Documenti/trampoline//make")
...
with_com = False
scheduler = "osek"
trampoline_base_path = "/home/$USER/Documenti/trampoline//"
cflags = []
cppflags = []
ldflags = []
asflags = []
...
includeDirs += ["-I","/home/$USER/Documenti/trampoline//machines/avr/arduino/cores/arduino"]
includeDirs += ["-I","/home/$USER/Documenti/trampoline//machines/avr/arduino/"]
includeDirs += ["-I","/home/$USER/Documenti/trampoline//machines/avr/arduino/variants/standard"]
includeDirs += ["-I","/home/$USER/Documenti/trampoline//machines/avr"]
if with_ioc:
  includeDirs += ["-I", "/home/$USER/Documenti/trampoline//ioc"]
includeDirs += ["-I", "/home/$USER/Documenti/trampoline//os"]
includeDirs += ["-I", "/home/$USER/Documenti/trampoline//debug"]
...
if True:
  postCommand = makefile.PostCommand("Generating binary ex1_exe.hex from ex1_exe")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("ex1_exe")
  postCommand.mCommand.append("ex1_exe.hex")
...
postVariableMapping = dict(
  MACHINE_PATH='/home/$USER/Documenti/trampoline//machines',
  ARCH_PATH='/home/$USER/Documenti/trampoline//machines/avr',
  BOARD_PATH='/home/$USER/Documenti/trampoline//machines/avr/arduino/uno',
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing ex1_exe on avr/arduino/uno\033[0m")
