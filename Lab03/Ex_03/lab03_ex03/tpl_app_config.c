 ...
 * Automatically generated by goil on Mon Nov 28 15:49:55 2022
...
CONST(tpl_appmode_mask, OS_CONST) tpl_alarm_app_mode[ALARM_COUNT] = {
  1 /* alarm a1000msec : stdAppmode */ ,
  1 /* alarm a1500msec : stdAppmode */ ,
  1 /* alarm a2800msec : stdAppmode */ 
};
...
/* Event heyImHere */
#define heyImHere_mask 1
CONST(EventMaskType, AUTOMATIC) heyImHere = heyImHere_mask;
...
/* Alarm a1000msec identifier */
#define a1000msec_id 0
CONST(AlarmType, AUTOMATIC) a1000msec = a1000msec_id;

/* Alarm a1500msec identifier */
#define a1500msec_id 1
CONST(AlarmType, AUTOMATIC) a1500msec = a1500msec_id;

/* Alarm a2800msec identifier */
#define a2800msec_id 2
CONST(AlarmType, AUTOMATIC) a2800msec = a2800msec_id;
...
/*
 * Event structure of task TaskC
 */
VAR(tpl_task_events, OS_VAR) TaskC_task_evts = {
  /* event set  */ 0,
  /* event wait */ 0
};
...
/*
 * Event structure of task TaskA
 */
VAR(tpl_task_events, OS_VAR) TaskA_task_evts = {
  /* event set  */ 0,
  /* event wait */ 0
};
...
CONST(tpl_task_activation_action, OS_CONST) a1000msec_action = {
  {
...
CONST(tpl_alarm_static, OS_CONST) a1000msec_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , a1000msec_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&a1000msec_action
};
...
VAR(tpl_time_obj, OS_VAR) a1000msec_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&a1000msec_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  977,
    /* date                         */  977,
...
CONST(tpl_task_activation_action, OS_CONST) a1500msec_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  TaskB_id
...
CONST(tpl_alarm_static, OS_CONST) a1500msec_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , a1500msec_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&a1500msec_action
};
...
VAR(tpl_time_obj, OS_VAR) a1500msec_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&a1500msec_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  1465,
    /* date                         */  1465,
...
CONST(tpl_task_activation_action, OS_CONST) a2800msec_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  TaskC_id
...
CONST(tpl_alarm_static, OS_CONST) a2800msec_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , a2800msec_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&a2800msec_action
};
...
VAR(tpl_time_obj, OS_VAR) a2800msec_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&a2800msec_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  2734,
    /* date                         */  2734,
...
CONSTP2VAR(tpl_time_obj, AUTOMATIC, OS_APPL_DATA)
  ...
  &a1000msec_alarm_desc,
  &a1500msec_alarm_desc,
  &a2800msec_alarm_desc
};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"
...
/*-----------------------------------------------------------------------------
 * Static internal receiving queued message object msgDataReceiveUnqueued
 */
 
#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

VAR(uint8, OS_VAR) msgDataReceiveUnqueued_buffer[3];
VAR(uint8, OS_VAR) msgDataReceiveUnqueued_last = 0;

VAR(tpl_queue_dyn, OS_VAR) msgDataReceiveUnqueued_dyn_queue = {
...
CONST(tpl_internal_receiving_queued_mo, OS_CONST) msgDataReceiveUnqueued_message = {
  ...
  { /*  queue structure   */
    /*  pointer to the dynamic descriptor   */  &msgDataReceiveUnqueued_dyn_queue,
    /*  max size of the queue               */  3*sizeof(uint8),
    /*  element size of the queue           */  sizeof(uint8),
    /*  pointer to the buffer               */  (tpl_com_data *)msgDataReceiveUnqueued_buffer,
    /*  pointer to the last written value   */  (tpl_com_data *)&msgDataReceiveUnqueued_last
  }
};
