...
if True:
  postCommand = makefile.PostCommand("Generating binary Lab_3_ex_3_exe.hex from Lab_3_ex_3_exe")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("Lab_3_ex_3_exe")
  postCommand.mCommand.append("Lab_3_ex_3_exe.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    commandLine += "Lab_3_ex_3_exe.hex "
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing Lab_3_ex_3_exe on avr/arduino/uno\033[0m")
