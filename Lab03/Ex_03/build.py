...
if True:
  postCommand = makefile.PostCommand("Generating binary ex3_exe.hex from ex3_exe")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("ex3_exe")
  postCommand.mCommand.append("ex3_exe.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing ex3_exe on avr/arduino/uno\033[0m")
