 ...
 * Automatically generated by goil on Mon Nov 28 19:02:00 2022
...
/* Resource toctocCanI */
#define toctocCanI_id 0
CONST(ResourceType, AUTOMATIC) toctocCanI = toctocCanI_id;
...
#include "tpl_memmap.h"
/*-----------------------------------------------------------------------------
 * Resource descriptor of resource toctocCanI
 *
 * Tasks which use this resource :
 * TaskA
 * TaskC
 */
VAR(tpl_resource, OS_VAR) toctocCanI_rez_desc = {
