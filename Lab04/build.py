...
#--- automatically generated by goil on Mon Dec 12 11:51:35 2022
...
cSourceList.append(projfile.ProjectFile("bufferArray.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary lab_4_ex_1_exe.hex from lab_4_ex_1_exe")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("lab_4_ex_1_exe")
  postCommand.mCommand.append("lab_4_ex_1_exe.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    commandLine += "lab_4_ex_1_exe.hex "
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing lab_4_ex_1_exe on avr/arduino/uno\033[0m")
